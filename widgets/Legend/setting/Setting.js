    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        if(config.syncWithWebmap) {
          this.syncWithWebmapToggle.check();
        } else {
          this.syncWithWebmapToggle.uncheck();
        }
      ...
      _onSyncWithWebmapToggleChange: function(checked) {
        if(checked) {
          html.addClass(this.layerChooserSection, 'disable');
        } else {
          html.removeClass(this.layerChooserSection, 'disable');
        }
      },
