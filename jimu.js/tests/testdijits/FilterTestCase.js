require(['doh/main', 'dojo/on', 'dojo/_base/html', 'dojo/Deferred', 'jimu/dijit/Filter', 'esri/request'],
  function(doh, on, html, Deferred, Filter, esriRequest) {
    ...
    var urls = [
      ...
      //test date field of hosted services
      'https://services2.arcgis.com/N4cKzJ9dzXmsPNRs/arcgis/rest/services/aquatic/FeatureServer/0',
      //test unicode field of hosted services
      'http://services1.arcgis.com/oC086ufSSQ6Avnw2/arcgis/rest/services/utf8-competitor/FeatureServer/0'
    ];
    ...
    doh.register("buildByExpr/toJson", [{
      ...
      runTest: function() {
        var s = "created_date NOT BETWEEN timestamp '2010-06-17 00:00:00' AND timestamp '2010-06-17 23:59:59'";
        return buildByExpr(s);
      }
    }, {
      ...
      runTest: function() {
        var s = "created_date NOT BETWEEN timestamp '2008-09-06 00:00:00' AND timestamp '2012-06-10 23:59:59'";
        return buildByExpr(s);
      }
    }, {
